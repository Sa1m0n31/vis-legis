...
function vislegis_scripts() {
    ...
    wp_enqueue_style( 'vislegis-style', get_stylesheet_uri(), array(), _S_VERSION );

	wp_enqueue_script( 'main', get_template_directory_uri() . '/js/main.js', array('lozad'), _S_VERSION, true );
	wp_enqueue_script( 'lozad', 'https://cdn.jsdelivr.net/npm/lozad/dist/lozad.min.js', array(), _S_VERSION, true );
